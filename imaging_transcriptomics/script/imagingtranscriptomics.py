...
def build_parser() -> argparse.ArgumentParser:
    ...
    parser = argparse.ArgumentParser(
        ...
        epilog=(
            ...
            "  imagingtranscriptomics corr --input map.nii.gz --space MNI152 --atlas dk --output out_dir\n"
            "  imagingtranscriptomics corr --input map.nii.gz --space MNI152 --atlas schaefer-200 \\\n"
            "    --ora-p-threshold 0.05 --geneset lake --output out_dir\n"
            "  imagingtranscriptomics pls --input map.nii.gz --space MNI152 --atlas dk --ncomp 2 --output out_dir"
        ),
    )
    ...
    corr_parser = subparsers.add_parser(
        ...
        epilog=(
            ...
            "  imagingtranscriptomics corr --input map.nii.gz --space MNI152 --atlas schaefer-200 \\\n"
            "    --ora-p-threshold 0.05 --geneset lake --output out_dir\n"
            "  imagingtranscriptomics corr --input map.nii.gz --space MNI152 --atlas dk \\\n"
    ...
    pls_parser = subparsers.add_parser(
        ...
        epilog=(
            "Examples:\n"
            "  imagingtranscriptomics pls --input map.nii.gz --space MNI152 --atlas dk --ncomp 2 --output out_dir\n"
            "  imagingtranscriptomics pls --input map.nii.gz --space MNI152 --atlas dk --var 0.5 \\\n"
            "    --ora-p-threshold 0.05 --geneset lake --output out_dir"
        ),
    )
